...
@Component({
  selector: 'ngx-temperature-dragger-1',
  templateUrl: './temperature-dragger-1.component.html',
  styleUrls: ['./temperature-dragger-1.component.scss'],
})
export class TemperatureDragger1Component implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = TemperatureDragger1Component.toRad(this.bottomAngle);
    this.calculateVars();
